...
(representado como n!) es el producto de n por todos los números naturales menores que él y mayores a 0. Ejemplo: 5! = 5 * 4 * 3 * 2 * 1
...
/*
  ...
  function nFibonacci(n) {
    ...
    for(let i = 0; i < n; i++){
      resultado [i] = nAnterior + nSiguiente;
      aux = nAnterior;
      nAnterior = nSiguiente;
      nSiguiente = aux + nSiguiente;
    }
